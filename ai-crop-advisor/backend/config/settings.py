...
# DEBUG is handled via os.getenv("DEBUG")

# Production hosts should be comma-separated in the environment
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Backend APIs for AI-powered crop recommendation system",
    "VERSION": "1.0.0",
}
